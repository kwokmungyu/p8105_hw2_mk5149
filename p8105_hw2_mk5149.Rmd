...
Answer: The total number of cigarette butts collected was `r all_trash_wheel_data |> filter(trash_wheel_name == "Gwynnda, the Good Wheel of the West", year == 2022, month == "June") |> summarize(total_butts = sum(cigarette_butts, na.rm = TRUE)) |> pull(total_butts) |> format(big.mark = ",")`.  
